  ...
  return (
    <header>
      <nav>
            ...
            <div className="row align-items-center">
                  ...
                  <ul>
                    <li>
                      <Link
                        ...
                        to="/"
                        className={activeRoutes.Home ? "activeTab" : ""}
                      >
                        Home
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/about"
                        className={activeRoutes.About ? "activeTab" : ""}
                      >
                        About
                      </Link>
                    </li>
                    ...
                    <li className="has-child-menu">
                      ...
                      <ul className="sub-menu">
                        ...
                        <li>
                          <Link to="case-study-sidebar.html">
                            Case Study Sidebar
                          </Link>
                        </li>
                        <li>
                          <Link to="case-details.html">Case Study Details</Link>
                        </li>
                        <li>
              ...
              <div className="col-xxl-2 col-xl-3 col-lg-3 col-sm-5 col-5 order-1 order-lg-2">
                <div className="menu-btn-wrap ">
                  <Link className="menu-btn d-none d-lg-block" to="/login">
                    <i className="bi bi-person"></i> Sign In
                  </Link>
        ...
        <div className="menu-info-wrap d-none d-xxl-block position-absolute">
          <div className="menu-info-shape position-relative">
            ...
            <Link to="https://themeforest.wprealizer.com/cdn-cgi/l/email-protection#275748554654524946094e49414867404a464e4b0944484a">
              <i className="bi bi-envelope-fill"></i>{" "}
              <span
                className="__cf_email__"
                data-cfemail="2c5c435e4d5f59424d0245424a436c48494143024f4341"
              >
                [email&#160;protected]
              </span>
            </Link>
          ...
          <div className="menu-info-content">
            <p>
              ...
              <Link to="tel:01716900768">+254 7 99039 109</Link>
            </p>
          </div>
        </div>
      </nav>
      ...
      <div className="hero-area hero-style-two positioning">
          ...
          <div className="row align-items-center ">
            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 order-1 order-lg-0 mobt-60">
              <div className="hero-content hero-content-style-2">
                ...
                <h2>
                  Looking for <Link to="contact.html">help</Link> from premier
                  Assignment.
                </h2>
        ...
        <img
          className="shape hero-round-1"
          src="assets/images/shape/hero-round.png"
          alt=""
        />
      </div>
    </header>
